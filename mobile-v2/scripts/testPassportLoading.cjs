...
function load() {
  ...
  const globals = { React: host.React, ...host.React, ...geometry, Platform: { OS: 'android' }, View: 'View', Text: 'Text', Pressable: 'Pressable', WebView: 'WebView', WWEmblem: 'WWEmblem', StyleSheet: { create: s => s }, colors: {}, fonts: {}, selectionHaptic() {},
