...
const noHome = { ...archive, homeAirport: ' ', homeAirportName: '', airports: [{ code: 'DFW', city: 'Dallasâ€“Fort Worth', flights: 31, trips: [] }, { code: 'AMS', city: 'Amsterdam', flights: 2, trips: [] }] };
assert.deepEqual(passportIdentityAirport(noHome), { label: 'Most used airport', code: 'DFW', place: 'Dallasâ€“Fort Worth' }, 'A real most-used airport fills the identity page without inventing a home');
