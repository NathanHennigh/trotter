...
`assets/world-window/fonts/Newsreader-Italic.ttf` is the unmodified `Newsreader16pt-Italic.ttf` from the official [Production Type NewsReader repository](https://github.com/productiontype/NewsReader/blob/1ece6a8bfe5db1a2b90c76cc1fe5d3b2eed5dcf3/fonts/static/ttf/Newsreader16pt-Italic.ttf), pinned to commit `1ece6a8bfe5db1a2b90c76cc1fe5d3b2eed5dcf3`. SHA-256: `292646cbb948153511e308fa80def59959746d70114bd0936ba0a7f67a33181d` (verified against the bundled file). Its SIL Open Font License is preserved in `assets/world-window/fonts/newsreader-OFL.txt`.
